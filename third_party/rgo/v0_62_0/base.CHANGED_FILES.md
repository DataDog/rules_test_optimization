...
- Commit: `c6b35c2367d164f27af4825422d5c70c3365f6fb`
- Tag: `v0.62.0`
- Vendored fork: `third_party/rgo/v0_62_0/base`
- Regenerate: `python3 tools/dev/diff_rules_go_fork.py --upstream v0_62_0 --variant base --write-report`
...
_Generated from `third_party/rgo/v0_62_0/base.METADATA.json` using `tools/dev/diff_rules_go_fork.py`._
