...
def _go_cache_selection_test(ctx):
    ...
    fallback = orchestrion_extension_test_helpers.select_go_cache_env(
        linux_ctx,
        parsed.gocache,
        parsed.gomodcache,
        "/repo/.orchestrion_bootstrap_go_cache",
    ...
    windows_fallback = orchestrion_extension_test_helpers.select_go_cache_env(
        struct(os = struct(name = "windows_nt")),
        "C:\\Users\\runner\\go-build",
        "C:\\Users\\runner\\go\\pkg\\mod",
        "C:\\repo\\.orchestrion_bootstrap_go_cache",
        True,
        False,
    )
