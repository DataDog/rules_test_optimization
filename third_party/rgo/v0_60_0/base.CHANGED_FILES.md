...
- Tag: `v0.60.0`
- Vendored fork: `third_party/rgo/v0_60_0/base`
- Regenerate: `python3 tools/dev/diff_rules_go_fork.py --upstream v0_60_0 --variant base --write-report`
...
- `go/private/actions/BUILD.bazel`
...
_Generated from `third_party/rgo/v0_60_0/base.METADATA.json` using `tools/dev/diff_rules_go_fork.py`._
