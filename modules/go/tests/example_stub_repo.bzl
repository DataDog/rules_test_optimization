"""Dev-only module extension providing local test optimization data repo.

This companion-module copy avoids exposing core `tools/tests` internals as a
public API surface while still letting `cd modules/go && bazel test //...`
resolve `@test_optimization_data` labels used by macro analysis tests.
"""
