...
def _validate_ruby_test_rule_or_fail(ruby_test_rule):
    if ruby_test_rule == None:
        fail_with_prefix("dd_topt_ruby_test", "you must pass ruby_test_rule for your selected Ruby test rule")

def _select_service_entry_or_fail(topt_data, topt_service):
    return select_service_entry_or_fail(topt_data, topt_service, macro_name = "dd_topt_ruby_test")
...
def _build_module_labels(sync_repo_name, labels):
    return build_module_labels(sync_repo_name, labels, macro_name = "dd_topt_ruby_test")
...
def dd_topt_ruby_test(
    ...
    if not sync_repo_name:
        fail_with_prefix("dd_topt_ruby_test", "selected topt_data entry is missing required 'repo_name'")
