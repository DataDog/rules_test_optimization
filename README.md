...
`v2.9.0-dev.0.20260408120305-80f98e63de50`.
...
bazel run @datadog-rules-test-optimization-go//:dd_topt_go_bootstrap -- \
  ...
  --dd-trace-go-version v2.9.0-dev.0.20260408120305-80f98e63de50
```
...
non-default tracer version; otherwise the default is `v2.9.0-dev.0.20260408120305-80f98e63de50`.
...
If both settings are omitted, the default is still `v2.9.0-dev.0.20260408120305-80f98e63de50`. Manual setups
