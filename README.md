...
`v2.9.0-dev.0.20260408173856-00e7bd515e27`.
...
bazel run @datadog-rules-test-optimization-go//:dd_topt_go_bootstrap -- \
  ...
  --dd-trace-go-version v2.9.0-dev.0.20260408173856-00e7bd515e27
```
...
non-default tracer version; otherwise the default is `v2.9.0-dev.0.20260408173856-00e7bd515e27`.
...
If both settings are omitted, the default is still `v2.9.0-dev.0.20260408173856-00e7bd515e27`. Manual setups
