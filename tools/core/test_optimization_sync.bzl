...
def _render_disabled_settings_json():
    """Render the canonical disabled settings response."""
    return json.encode({
        "data": {
            "attributes": {
...
def _render_disabled_known_tests_json():
    """Render the canonical empty known-tests response."""
    return json.encode({"data": {"attributes": {"tests": {}}}}) + "\n"

def _render_disabled_test_management_json():
    """Render the canonical empty test-management response."""
    return json.encode({"data": {"attributes": {"modules": {}}}}) + "\n"

def _render_disabled_flaky_tests_json():
    """Render the canonical empty flaky-tests response."""
...
def _write_disabled_repository(ctx, out_dir, env_data, debug):
    ...
    ctx.file(known_tests_file, _render_disabled_known_tests_json())
    ctx.file(test_management_file, _render_disabled_test_management_json())
    ctx.file(flaky_tests_file, _render_disabled_flaky_tests_json())
    ctx.file(
        context_file,
...
render_disabled_flaky_tests_json_for_tests = _render_disabled_flaky_tests_json
render_disabled_known_tests_json_for_tests = _render_disabled_known_tests_json
render_disabled_settings_json_for_tests = _render_disabled_settings_json
